                                ...
                                <div class="cart-page-item">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-2 col-sm-3 col-0">
                                                <img class="cart-page__item-image"
                                                    src="<?php echo $param->image_url ?>" />
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-4 col-5">
                                                <h6><?php echo $param->name ?></h6>
                                                <div>Giá đơn vị: <?php echo $param->price ?> đ</div>
                                                <div>Size: <?php echo sizeContent($param->size) ?></div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-5">
                                                <div class="product-detail-footer">
                                                    <div class="product-detail-footer-quantity">
                                                        ...
                                                        <input type="text" name="quantity"
                                                            class="form-control quantity-input" id="product-quantity"
                                                            value="<?php echo $param->quantity ?>">
